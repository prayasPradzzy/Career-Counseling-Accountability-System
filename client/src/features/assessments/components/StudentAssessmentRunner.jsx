...
function StudentPersonalitySnapshot({ assessmentKey, definitionTitle, session, onBack, router }) {
      ...
      <Card className="border-emerald-500/40 shadow-lg bg-card overflow-hidden">
        ...
        <CardContent className="space-y-4 pb-6">
          {isLoading ? (
            ...
            <div className="p-4 rounded-lg bg-muted/40 border text-center space-y-2">
              <p className="text-sm font-semibold">Assessment Submitted</p>
              <p className="text-xs text-muted-foreground">
                Your responses have been recorded and saved. Your counselor will review your results with you.
              </p>
            </div>
          ) : (
          ...
          <div className="text-center text-[11px] text-muted-foreground pt-2">
            Submitted on {formatSubmittedTime(session?.submittedAt || results.completedAt)}
          </div>
        </CardContent>
