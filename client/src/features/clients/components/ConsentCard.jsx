 ...
 * Displays client data consent status and allows toggling or viewing consent forms.
 */
export function ConsentCard({ consentStatus, onUpdateConsent, isUpdating, className }) {
  ...
  return (
    <SectionCard
      ...
      subtitle="Client authorization for career data processing and assessment storage"
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {isGiven ? `Granted on ${givenAtFormatted}` : "Client has not submitted signed consent."}
              </p>
            </div>
          </div>
