...
const LEGACY_STATUS_CONFIGS = {
  ...
  rejected: { label: "Retake Requested", className: "bg-amber-500/10 text-amber-700 border-amber-500/30 dark:text-amber-400 font-semibold" },
  retake_requested: { label: "Retake Requested", className: "bg-amber-500/10 text-amber-700 border-amber-500/30 dark:text-amber-400 font-semibold" },
